...
//     Component* get_component_from_entity(int16_t entity_id, std::type_index typ);
//     std::vector<Component*> get_components_from_entity(int16_t entity_id, std::type_index typ);
//     //Gets a component of type typ on the entity that comp_id is on
//     Component* get_on(int16_t comp_id, std::type_index ftyp, std::type_index typ);
//     std::vector<Component*> get_all_on(int16_t comp_id, std::type_index ftyp, std::type_index typ);
    
    
//     bool singleton_exists(std::type_index typ);
//     Component* get_singleton(std::type_index typ);
//     int16_t get_singleton_comp_id(std::type_index typ);

//     bool is_typ(int16_t comp_id, std::type_index typ);
